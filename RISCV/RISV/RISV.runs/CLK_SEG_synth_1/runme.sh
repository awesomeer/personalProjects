...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/CLK_SEG_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLK_SEG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLK_SEG.tcl
