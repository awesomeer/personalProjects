...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/unsigned_mulh_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unsigned_mulh.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unsigned_mulh.tcl
