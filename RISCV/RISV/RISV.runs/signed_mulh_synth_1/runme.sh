...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/signed_mulh_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signed_mulh.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signed_mulh.tcl
