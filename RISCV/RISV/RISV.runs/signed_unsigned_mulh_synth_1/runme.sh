...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/signed_unsigned_mulh_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signed_unsigned_mulh.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signed_unsigned_mulh.tcl
