...
#
# Generated by export_simulation on Fri Jul 16 20:59:47 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './signed_mulh.sh' script.

./signed_mulh.sh -reset_run
...
./signed_mulh.sh -noclean_files

For more information on the script, please type './signed_mulh.sh -help'.
