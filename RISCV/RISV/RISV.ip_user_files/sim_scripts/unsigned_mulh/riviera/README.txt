...
#
# Generated by export_simulation on Fri Jul 16 21:01:21 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './unsigned_mulh.sh' script.

./unsigned_mulh.sh -reset_run
...
./unsigned_mulh.sh -noclean_files

For more information on the script, please type './unsigned_mulh.sh -help'.
