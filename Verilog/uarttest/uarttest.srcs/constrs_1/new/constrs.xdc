...
set_property IOSTANDARD LVCMOS33 [get_ports {tx_ready_led}]
set_property PACKAGE_PIN K12 [get_ports {rx_data_ready}]
set_property IOSTANDARD LVCMOS33 [get_ports {rx_data_ready}]
...
set_property PULLDOWN true [get_ports {start_tx}]
