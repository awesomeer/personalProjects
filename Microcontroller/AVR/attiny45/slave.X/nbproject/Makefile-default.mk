...
${OBJECTDIR}/slave.o: slave.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/slave.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=attiny45 ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O0 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/slave.o.d" -MT "${OBJECTDIR}/slave.o.d" -MT ${OBJECTDIR}/slave.o  -o ${OBJECTDIR}/slave.o slave.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
