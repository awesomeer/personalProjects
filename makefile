...
STM32CubeL4_CMSIS := submodules/cmsis-device-l4
...
INC_DIR := inc
SUB_INCS := $(STM32CubeL4_CMSIS)/Include \
...
SINGLE_SRCS := 	$(STM32CubeL4_CMSIS)/Source/Templates/system_stm32l4xx.c \
...
# All Assembly Files
SUB_ASMS := $(STM32CubeL4_CMSIS)/Source/Templates/gcc/startup_stm32l432xx.s \
